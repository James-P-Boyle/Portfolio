...
export default function SocialLinks() {
    ...
    return (
        <div id="socialLinks">
            ...
            <Button addedClasses="social-button">
                <a href="mailto:james.patrick.boyle92@gmail.com">
                    <svg viewBox="0 0 24 24">
                        <path fill="currentColor" fillRule="evenodd" d="M3.01 5.838a1 1 0 011-1H20a1 1 0 011 1v11.324a2 2 0 01-2 2H5a2 2 0 01-2-2v-11c0-.048.003-.094.01-.14v-.184zM5 8.062v9.1h14v-9.1l-4.879 4.879a3 3 0 01-4.242 0L5 8.06zm1.572-1.256h10.856l-4.72 4.72a1 1 0 01-1.415 0l-4.72-4.72z"/>
                    </svg>
                </a>   
            </Button>

            <Button addedClasses="social-button">
                <a href="https://github.com/James-P-Boyle" target="_blank">
            ...
            <Button addedClasses="social-button">
                <a href="https://www.linkedin.com/in/james-p-boyle/" target="_blank">
                    <svg viewBox="0 0 24 24" fill="currentColor">
                        <path fill="none" d="M0 0h24v24H0z" />
